...
public class Hours extends AppCompatActivity {
    ...
    private Button saveButton, infoButton;
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i = 0; i < closeField.size(); i++){
                    String openTimes = String.valueOf(openField.get(i).getHour() + ":" + (String.valueOf(openField.get(i)
                            .getMinute()).length()==1 ? "0" : "")
                            + String.valueOf(openField.get(i).getMinute()));
                    String closeTimes = String.valueOf(closeField.get(i).getHour() + ":" + (String.valueOf(closeField.get(i)
                            .getMinute()).length()==1 ? "0" : "" )
                            + String.valueOf(closeField.get(i).getMinute()));
