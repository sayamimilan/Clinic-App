...
public class WalkInClinic implements Serializable {
    ...
    public WalkInClinic(String name, String address, ArrayList<PaymentMethod> paymentMethods, String phoneNumber, ArrayList<String> openingTimes, ArrayList<String> closingTimes, String status){
        _name = name;
        _address = address;
    ...
    public WalkInClinic(String name, String address, ArrayList<PaymentMethod> paymentMethods, String phoneNumber){
        _name = name;
        _address = address;
        _paymentMethods = paymentMethods;
        _phoneNumber = phoneNumber;
    ...
    public WalkInClinic(String name, String address, ArrayList<PaymentMethod> paymentMethods, String phoneNumber, ArrayList<String> openingTimes, ArrayList<String> closingTimes, ArrayList<String> serviceIds, String status){
        _name = name;
        _address = address;
        _paymentMethods = paymentMethods;
        _phoneNumber = phoneNumber;
